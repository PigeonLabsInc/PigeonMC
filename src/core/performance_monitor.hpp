...
private:
    ...
    timestamp_t last_network_update_;
    ...
    void monitor_loop() {
        ...
        while (monitoring_.load()) {
            ...
            auto sleep_duration = std::chrono::milliseconds(50) - 
                                 (start - last_tick);
            ...
            f64 actual_tps = 1000000.0 / tick_time;
    ...
    void update_network_stats() {
        ...
        auto elapsed = std::chrono::duration_cast<std::chrono::milliseconds>(
            current_time - last_network_update_).count();
        
        if (elapsed >= 1000) {
            u64 current_packets = packet_count_.exchange(0);
            u64 current_bytes = byte_count_.exchange(0);
            
            packets_per_second_.store(current_packets * 1000 / elapsed);
            bytes_per_second_.store(current_bytes * 1000 / elapsed);
...
public:
    ...
    void record_packet(size_t byte_size) {
        ...
        byte_count_.fetch_add(byte_size);
    }
